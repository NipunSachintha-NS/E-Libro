      ...
      <div className="bg-blue-100 p-8 rounded-lg shadow-lg ">
        ...
        <form onSubmit={passData}>
          <input
            type="text"
            placeholder="Name"
            className="block w-full mb-4 px-3 py-2 text-sm border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500" onChange={(e)=> setName(e.target.value)}
            value={name}
          />
          <input
            type="text"
